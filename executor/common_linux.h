...
#if SYZ_EXECUTOR || __NR_syz_io_uring_params
...
static long syz_io_uring_complete(volatile long a0, volatile long a1)
{
	...
	// C:       syz_io_uring_complete(struct io_uring_params* ring_params_ptr, char* ring_ptr)
	...
	uint32 cqe_size = (params->flags & IORING_SETUP_CQE32) ? SIZEOF_IO_URING_CQE32 : SIZEOF_IO_URING_CQE;
	char* cqe_src = ring_ptr + params->cq_off.cqes + cq_head * cqe_size;
...
{
	// syzlang: syz_io_uring_setup(entries int32[1:IORING_MAX_ENTRIES], ring_params_ptr ptr[inout, io_uring_params], ring_ptr ptr[out, ring_ptr], sqes_ptr ptr[out, sqes_ptr]) fd_io_uring
	// C:       syz_io_uring_setup(uint32 entries, struct io_uring_params* ring_params_ptr, void** ring_ptr_out, void** sqes_ptr_out) // returns uint32 fd_io_uring
	...
	uint32 cqe_size = (setup_params->flags & IORING_SETUP_CQE32) ? SIZEOF_IO_URING_CQE32 : SIZEOF_IO_URING_CQE;
	...
	*ring_ptr_out = mmap(0, ring_sz, PROT_READ | PROT_WRITE, MAP_SHARED | MAP_POPULATE, fd_io_uring, IORING_OFF_SQ_RING);
	...
	uint32 sqe_size = (setup_params->flags & IORING_SETUP_SQE128) ? SIZEOF_IO_URING_SQE128 : SIZEOF_IO_URING_SQE;
...
static long syz_io_uring_submit(volatile long a0, volatile long a1, volatile long a2, volatile long a3)
{
	...
	// C:       syz_io_uring_submit(struct io_uring_params* ring_params_ptr, char* ring_ptr,		io_uring_sqe* sqes_ptr,    io_uring_sqe* sqe)
	...
	uint32 sqe_size = (params->flags & IORING_SETUP_SQE128) ? SIZEOF_IO_URING_SQE128 : SIZEOF_IO_URING_SQE;
